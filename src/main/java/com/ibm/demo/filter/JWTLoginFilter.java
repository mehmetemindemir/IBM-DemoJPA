package com.ibm.demo.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.exc.UnrecognizedPropertyException;
import com.google.gson.Gson;
import com.ibm.demo.entity.ErrorDetail;
import com.ibm.demo.entity.UserCritea;
import com.ibm.demo.security.TokenAuthenticationService;
...
public class JWTLoginFilter extends AbstractAuthenticationProcessingFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
		...
		UserCritea creds = null;
		try {
            String marshalledXml = org.apache.commons.io.IOUtils.toString(req.getInputStream());
			creds = new ObjectMapper().readValue(marshalledXml, UserCritea.class);
			marshalledXml = null;
